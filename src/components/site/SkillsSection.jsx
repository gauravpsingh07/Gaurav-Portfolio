...
const skillGroups = [
  ...
  },
  {
    ...
    skills: ["Node.js", "Express.js", "Django REST Framework", "FastAPI", "REST APIs", "JWT"],
  ...
  },
  {
    ...
    skills: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "Prisma", "ClickHouse"],
  ...
  },
  {
    ...
    skills: ["AWS", "Docker", "Kubernetes", "Nginx", "Gunicorn", "GitHub Actions", "CI/CD"],
  ...
  },
  {
    ...
    skills: ["Jest", "Pytest", "Vitest", "Zod", "Postman", "Swagger/OpenAPI", "Gemini API"],
